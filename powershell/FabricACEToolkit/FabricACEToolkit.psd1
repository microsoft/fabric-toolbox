...
Copyright = '2025 FabricACEToolkit by Tiago Balabuch'
...
FunctionsToExport = 'Get-FabricCapacity', 'Get-FabricDashboard', 'Get-FabricDataPipeline', 
               'New-FabricDataPipeline', 'Remove-FabricDataPipeline', 
               'Update-FabricDataPipeline', 'Get-FabricDatamart', 
               ...
               'Get-FabricTenantSettingOverridesCapacity', 'Convert-FromBase64', 
               'Convert-ToBase64', 'Get-FabricLongRunningOperation', 
               'Get-FabricLongRunningOperationResult', 'Set-FabricApiHeaders', 
