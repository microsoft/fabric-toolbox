...
Remaining verified gaps: workspace outbound/network policies; org-wide admin refreshables; anything under the platform meta-bucket not yet covered. (SQL DB start/stop mirroring already exist.)
