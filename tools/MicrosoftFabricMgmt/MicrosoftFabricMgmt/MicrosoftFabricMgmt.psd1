...
FunctionsToExport = 'Get-FabricCapacity', 'Get-FabricCopyJob', 
               ...
               'Get-FabricExternalDataShares', 'Revoke-FabricExternalDataShares', 
               'Get-FabricKQLDashboard', 'Get-FabricKQLDashboardDefinition', 
               'New-FabricKQLDashboard', 'Remove-FabricKQLDashboard', 
               'Update-FabricKQLDashboard', 'Update-FabricKQLDashboardDefinition', 
               'Get-FabricKQLDatabase', 'Get-FabricKQLDatabaseDefinition', 
               'New-FabricKQLDatabase', 'Remove-FabricKQLDatabase', 
               'Update-FabricKQLDatabase', 'Update-FabricKQLDatabaseDefinition', 
               'Get-FabricKQLQueryset', 'Get-FabricKQLQuerysetDefinition', 
               'New-FabricKQLQueryset', 'Remove-FabricKQLQueryset', 
               'Update-FabricKQLQueryset', 'Update-FabricKQLQuerysetDefinition', 
               'Get-FabricLakehouse', 'Get-FabricLakehouseTable', 
               'Load-FabricLakehouseTable', 'New-FabricLakehouse', 
               'Remove-FabricLakehouse', 'Start-FabricLakehouseTableMaintenance', 
               'Update-FabricLakehouse', 'Get-FabricMirroredDatabase', 
               ...
               'Get-FabricSparkWorkspaceSettings', 'New-FabricSparkCustomPool', 
               ...
               'Get-FabricSQLEndpoint', 'Get-FabricCapacityTenantSettingOverrides', 
               ...
               'Get-FabricDigitalTwinBuilder', 'Get-FabricLongRunningOperation', 
               'Get-FabricLongRunningOperationResult', 'Get-FabricTags', 
               'Invoke-FabricAPIRequest', 'Set-FabricApiHeaders', 
               'Get-FabricWarehouse', 'New-FabricWarehouse', 
               'Remove-FabricWarehouse', 'Update-FabricWarehouse', 
