...
class AssessmentService:
    ...
    def assess(
        ...
        client = self._get_client(source=source)
        ...
        for workspace in workspaces:
            ...
            try:
                ...
                print(f"Failed to assess workspace {workspace}: {e}")
        ...
        self._save_assessment_summary(assessment_results, output_path)

        self._save_export_results(export_results, output_path)

        print(f"Individual workspace details saved in: {output_path}")
    ...
    def _save_export_results(self, results: Dict[str, Any], output_path: str) -> None:
        ...
        print(f"Export results summary saved to: {export_summary_file}")
