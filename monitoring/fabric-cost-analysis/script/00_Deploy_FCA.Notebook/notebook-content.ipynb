{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "eaf556bf-a2bf-4e00-af19-3865ec0c92d5",
   "metadata": {
    "microsoft": {
     "language": "python",
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":\"2026-02-25T08:36:12.6687828Z\",\"execution_start_time\":\"2026-02-25T08:36:16.67866Z\",\"execution_finish_time\":\"2026-02-25T08:36:27.4154861Z\",\"normalized_state\":\"finished\"}}",
    "jupyter": {
     "outputs_hidden": true
    },
    "microsoft": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8237fde6-cc95-44fc-9e3b-580beed8e084",
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:36:27.4169341Z\",\"execution_finish_time\":\"2026-02-25T08:36:27.6903801Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:36:27.6915058Z\",\"execution_finish_time\":\"2026-02-25T08:36:34.6192231Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:36:34.6204309Z\",\"execution_finish_time\":\"2026-02-25T08:37:19.8575749Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
   ...
   "source": [
    ...
    "branch = \"bugfix/ari/FinOpsFolderPath\"\n",
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:37:19.8586881Z\",\"execution_finish_time\":\"2026-02-25T08:37:20.1547775Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:37:20.1559991Z\",\"execution_finish_time\":\"2026-02-25T08:37:20.4332047Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "df6fb3b3-67fc-4cb9-bd20-cc91ae9ab704",
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:37:20.4343396Z\",\"execution_finish_time\":\"2026-02-25T08:37:23.4653832Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:37:23.466831Z\",\"execution_finish_time\":\"2026-02-25T08:37:24.6796017Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:37:24.6807133Z\",\"execution_finish_time\":\"2026-02-25T08:44:57.2899792Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:44:57.2911349Z\",\"execution_finish_time\":\"2026-02-25T08:47:15.7350738Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:47:15.7362973Z\",\"execution_finish_time\":\"2026-02-25T08:47:18.663046Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
  ...
  },
  {
   ...
   "id": "0930b8c2",
   "metadata": {
    "cellStatus": "{\"System Administrator\":{\"session_start_time\":null,\"execution_start_time\":\"2026-02-25T08:47:18.6641576Z\",\"execution_finish_time\":\"2026-02-25T08:48:22.2055117Z\",\"normalized_state\":\"finished\"}}",
    "microsoft": {
     "language": "python",
     "language_group": "jupyter_python"
    }
   ...
   "outputs": [],
   "source": [
    "# Updates maangement during a new installation\n",
    "run_fab_command('job run ' + trg_workspace_name + '.Workspace/Update_FCA_delivery.Notebook')"
   ]
  }
 ],
 "metadata": {
