...
| **Summary** | Inform | The page provides an overview of cost per capacities across different regions, helping stakeholders to understand cost distributions and resource allocations within a specified timeframe 🆕 [Fabric Maturity Score](./MaturityScore.md) | ![Summary Page](./media/Report_Summary.png) |
...
- https://www.youtube.com/live/KxRPZpxJZ0I
- ...
