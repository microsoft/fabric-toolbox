...
> [!IMPORTANT]  
> FUAM will support the Capacity Utilization Events mode in the future. This feature takes Fabric monitoring to the next level by providing near-real time CU consumption.
