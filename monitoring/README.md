...
15. Select the initial value of the **Workspace** parameter on the menu bar
    **Optionally:** 
    Define a default value for the Workspace parameter:
    - Navigate to '**Parameters**' on the '**Manage**' tab in **Edit mode**
    - Click on '**Edit**' at the '**Workspace'** parameter
    - Set a '**Default value**' and click on '**Done**'
...
10. Trigger the first initial refresh in Fabric
    - Optionally - [Schedule the semantic model refresh](https://learn.microsoft.com/en-us/power-bi/connect-data/refresh-scheduled-refresh)
